...
enum Proto_AgeRatingCategoryEnum: SwiftProtobuf.Enum {
  ...
  static let allCases: [Proto_AgeRatingCategoryEnum] = [
...
enum Proto_AgeRatingRatingEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_AgeRatingRatingEnum] = [
    .ageratingRatingNull,
    .three,
    .seven,
    .twelve,
...
enum Proto_AgeRatingContentDescriptionCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_AgeRatingContentDescriptionCategoryEnum] = [
...
enum Proto_GenderGenderEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case male // = 0
  case female // = 1
  case other // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_GenderGenderEnum] = [
    .male,
    .female,
    .other,
  ]
...
enum Proto_CharacterSpeciesEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_CharacterSpeciesEnum] = [
...
enum Proto_DateFormatChangeDateCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case yyyymmmmdd // = 0
  case yyyymmmm // = 1
  case yyyy // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_DateFormatChangeDateCategoryEnum] = [
    .yyyymmmmdd,
    .yyyymmmm,
    .yyyy,
    .yyyyq1,
...
enum Proto_WebsiteCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_WebsiteCategoryEnum] = [
    .websiteCategoryNull,
    .websiteOfficial,
    .websiteWikia,
    .websiteWikipedia,
...
enum Proto_ExternalGameCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_ExternalGameCategoryEnum] = [
...
enum Proto_ExternalGameMediaEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
enum Proto_GameCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case mainGame // = 0
  case dlcAddon // = 1
  case expansion // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_GameCategoryEnum] = [
    .mainGame,
    .dlcAddon,
    .expansion,
    .bundle,
...
enum Proto_GameStatusEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case released // = 0
  case alpha // = 2
  case beta // = 3
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_GameStatusEnum] = [
    .released,
    .alpha,
    .beta,
    .earlyAccess,
...
enum Proto_GameVersionFeatureCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case boolean // = 0
  case description_ // = 1
  case UNRECOGNIZED(Int)
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_GameVersionFeatureCategoryEnum] = [
    .boolean,
    .description_,
  ]
...
enum Proto_GameVersionFeatureValueIncludedFeatureEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case notIncluded // = 0
  case included // = 1
  case preOrderOnly // = 2
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_GameVersionFeatureValueIncludedFeatureEnum] = [
    .notIncluded,
    .included,
    .preOrderOnly,
  ]
...
enum Proto_PlatformCategoryEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_PlatformCategoryEnum] = [
...
enum Proto_RegionRegionEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_RegionRegionEnum] = [
    .regionRegionNull,
    .europe,
    .northAmerica,
    .australia,
...
enum Proto_TestDummyEnumTestEnum: SwiftProtobuf.Enum {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Proto_TestDummyEnumTestEnum] = [
...
struct Proto_MultiQueryResult: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_MultiQueryResultArray: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_AgeRatingResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_AgeRating: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_AgeRatingCategoryEnum = .ageratingCategoryNull

  var contentDescriptions: [Proto_AgeRatingContentDescription] = []

  var rating: Proto_AgeRatingRatingEnum = .ageratingRatingNull

  var ratingCoverURL: String = String()
...
struct Proto_AgeRatingContentDescriptionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_AgeRatingContentDescription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_AgeRatingContentDescriptionCategoryEnum = .ageratingcontentdescriptionCategoryNull
...
struct Proto_AlternativeNameResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var alternativenames: [Proto_AlternativeName] = []
...
struct Proto_AlternativeName: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_ArtworkResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var artworks: [Proto_Artwork] = []
...
struct Proto_CharacterResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var characters: [Proto_Character] = []
...
struct Proto_Character: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasMugShot: Bool {return _storage._mugShot != nil}
  ...
  var species: Proto_CharacterSpeciesEnum {
...
struct Proto_CharacterMugShotResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var charactermugshots: [Proto_CharacterMugShot] = []
...
struct Proto_CharacterMugShot: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_CollectionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collections: [Proto_Collection] = []
...
struct Proto_Collection: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var type: Proto_CollectionType {
    get {return _storage._type ?? Proto_CollectionType()}
  ...
  var asParentRelations: [Proto_CollectionRelation] {
    get {return _storage._asParentRelations}
    set {_uniqueStorage()._asParentRelations = newValue}
  }

  var asChildRelations: [Proto_CollectionRelation] {
    get {return _storage._asChildRelations}
    set {_uniqueStorage()._asChildRelations = newValue}
  }
...
struct Proto_CollectionMembershipResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collectionmemberships: [Proto_CollectionMembership] = []
...
struct Proto_CollectionMembership: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var collection: Proto_Collection {
  ...
  var type: Proto_CollectionMembershipType {
    get {return _storage._type ?? Proto_CollectionMembershipType()}
    set {_uniqueStorage()._type = newValue}
  }
  /// Returns true if `type` has been explicitly set.
  var hasType: Bool {return _storage._type != nil}
...
struct Proto_CollectionMembershipTypeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_CollectionMembershipType: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var allowedCollectionType: Proto_CollectionType {
    get {return _allowedCollectionType ?? Proto_CollectionType()}
    set {_allowedCollectionType = newValue}
  }
  /// Returns true if `allowedCollectionType` has been explicitly set.
  var hasAllowedCollectionType: Bool {return self._allowedCollectionType != nil}
  /// Clears the value of `allowedCollectionType`. Subsequent reads from it will return its default value.
  mutating func clearAllowedCollectionType() {self._allowedCollectionType = nil}
  ...
  fileprivate var _allowedCollectionType: Proto_CollectionType? = nil
  fileprivate var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

struct Proto_CollectionRelationResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collectionrelations: [Proto_CollectionRelation] = []
...
struct Proto_CollectionRelation: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var childCollection: Proto_Collection {
    get {return _childCollection ?? Proto_Collection()}
    set {_childCollection = newValue}
  }
  /// Returns true if `childCollection` has been explicitly set.
  var hasChildCollection: Bool {return self._childCollection != nil}
  /// Clears the value of `childCollection`. Subsequent reads from it will return its default value.
  mutating func clearChildCollection() {self._childCollection = nil}

  var parentCollection: Proto_Collection {
    get {return _parentCollection ?? Proto_Collection()}
    set {_parentCollection = newValue}
  }
  /// Returns true if `parentCollection` has been explicitly set.
  var hasParentCollection: Bool {return self._parentCollection != nil}
  /// Clears the value of `parentCollection`. Subsequent reads from it will return its default value.
  mutating func clearParentCollection() {self._parentCollection = nil}

  var type: Proto_CollectionRelationType {
    get {return _type ?? Proto_CollectionRelationType()}
    set {_type = newValue}
  }
  /// Returns true if `type` has been explicitly set.
  ...
  fileprivate var _childCollection: Proto_Collection? = nil
  fileprivate var _parentCollection: Proto_Collection? = nil
  fileprivate var _type: Proto_CollectionRelationType? = nil
  fileprivate var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

struct Proto_CollectionRelationTypeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collectionrelationtypes: [Proto_CollectionRelationType] = []
...
struct Proto_CollectionRelationType: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var allowedChildType: Proto_CollectionType {
    get {return _storage._allowedChildType ?? Proto_CollectionType()}
    set {_uniqueStorage()._allowedChildType = newValue}
  }
  /// Returns true if `allowedChildType` has been explicitly set.
  var hasAllowedChildType: Bool {return _storage._allowedChildType != nil}
  /// Clears the value of `allowedChildType`. Subsequent reads from it will return its default value.
  mutating func clearAllowedChildType() {_uniqueStorage()._allowedChildType = nil}

  var allowedParentType: Proto_CollectionType {
    get {return _storage._allowedParentType ?? Proto_CollectionType()}
    set {_uniqueStorage()._allowedParentType = newValue}
  }
  /// Returns true if `allowedParentType` has been explicitly set.
  var hasAllowedParentType: Bool {return _storage._allowedParentType != nil}
  /// Clears the value of `allowedParentType`. Subsequent reads from it will return its default value.
  mutating func clearAllowedParentType() {_uniqueStorage()._allowedParentType = nil}
...
struct Proto_CollectionTypeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var collectiontypes: [Proto_CollectionType] = []
...
struct Proto_CollectionType: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_CompanyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_Company: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var changeDate: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasChangeDate: Bool {return _storage._changeDate != nil}
  /// Clears the value of `changeDate`. Subsequent reads from it will return its default value.
  mutating func clearChangeDate() {_uniqueStorage()._changeDate = nil}

  var changeDateCategory: Proto_DateFormatChangeDateCategoryEnum {
    get {return _storage._changeDateCategory}
    set {_uniqueStorage()._changeDateCategory = newValue}
  }

  var changedCompanyID: Proto_Company {
  ...
  var hasChangedCompanyID: Bool {return _storage._changedCompanyID != nil}
  /// Clears the value of `changedCompanyID`. Subsequent reads from it will return its default value.
  mutating func clearChangedCompanyID() {_uniqueStorage()._changedCompanyID = nil}
  ...
  var startDateCategory: Proto_DateFormatChangeDateCategoryEnum {
...
struct Proto_CompanyLogoResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var companylogos: [Proto_CompanyLogo] = []
...
struct Proto_CompanyLogo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_CompanyWebsiteResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var companywebsites: [Proto_CompanyWebsite] = []
...
struct Proto_CompanyWebsite: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_WebsiteCategoryEnum = .websiteCategoryNull
...
struct Proto_CoverResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var covers: [Proto_Cover] = []
...
struct Proto_Cover: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var gameLocalization: Proto_GameLocalization {
  ...
  var hasGameLocalization: Bool {return _storage._gameLocalization != nil}
  /// Clears the value of `gameLocalization`. Subsequent reads from it will return its default value.
  mutating func clearGameLocalization() {_uniqueStorage()._gameLocalization = nil}
...
struct Proto_EventResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var events: [Proto_Event] = []
...
struct Proto_Event: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var eventLogo: Proto_EventLogo {
    get {return _storage._eventLogo ?? Proto_EventLogo()}
    set {_uniqueStorage()._eventLogo = newValue}
  }
  /// Returns true if `eventLogo` has been explicitly set.
  var hasEventLogo: Bool {return _storage._eventLogo != nil}
  /// Clears the value of `eventLogo`. Subsequent reads from it will return its default value.
  ...
  var liveStreamURL: String {
    get {return _storage._liveStreamURL}
    set {_uniqueStorage()._liveStreamURL = newValue}
  }
  ...
  var videos: [Proto_GameVideo] {
    get {return _storage._videos}
    set {_uniqueStorage()._videos = newValue}
  }

  var eventNetworks: [Proto_EventNetwork] {
    get {return _storage._eventNetworks}
    set {_uniqueStorage()._eventNetworks = newValue}
  }
...
struct Proto_EventLogoResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var eventlogos: [Proto_EventLogo] = []
...
struct Proto_EventLogo: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var event: Proto_Event {
    get {return _storage._event ?? Proto_Event()}
...
struct Proto_EventNetworkResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_EventNetwork: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var networkType: Proto_NetworkType {
    get {return _networkType ?? Proto_NetworkType()}
    set {_networkType = newValue}
  }
  /// Returns true if `networkType` has been explicitly set.
  var hasNetworkType: Bool {return self._networkType != nil}
  ...
  fileprivate var _event: Proto_Event? = nil
  fileprivate var _networkType: Proto_NetworkType? = nil
  fileprivate var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
}

struct Proto_ExternalGameResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var externalgames: [Proto_ExternalGame] = []
...
struct Proto_ExternalGame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_ExternalGameCategoryEnum = .externalgameCategoryNull
  ...
  var media: Proto_ExternalGameMediaEnum = .externalgameMediaNull

  var platform: Proto_Platform {
...
struct Proto_FranchiseResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_Franchise: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_Game: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var aggregatedRatingCount: Int32 {
  ...
  var firstReleaseDate: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasFirstReleaseDate: Bool {return _storage._firstReleaseDate != nil}
  /// Clears the value of `firstReleaseDate`. Subsequent reads from it will return its default value.
  mutating func clearFirstReleaseDate() {_uniqueStorage()._firstReleaseDate = nil}
  ...
  var hasFranchise: Bool {return _storage._franchise != nil}
  /// Clears the value of `franchise`. Subsequent reads from it will return its default value.
  mutating func clearFranchise() {_uniqueStorage()._franchise = nil}
  ...
  var keywords: [Proto_Keyword] {
    get {return _storage._keywords}
    set {_uniqueStorage()._keywords = newValue}
  }

  var multiplayerModes: [Proto_MultiplayerMode] {
  ...
  var hasParentGame: Bool {return _storage._parentGame != nil}
  /// Clears the value of `parentGame`. Subsequent reads from it will return its default value.
  mutating func clearParentGame() {_uniqueStorage()._parentGame = nil}

  var platforms: [Proto_Platform] {
  ...
  var status: Proto_GameStatusEnum {
  ...
  var hasVersionParent: Bool {return _storage._versionParent != nil}
  /// Clears the value of `versionParent`. Subsequent reads from it will return its default value.
  mutating func clearVersionParent() {_uniqueStorage()._versionParent = nil}
...
struct Proto_GameEngineResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameEngine: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameEngineLogoResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var gameenginelogos: [Proto_GameEngineLogo] = []
...
struct Proto_GameEngineLogo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameLocalizationResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameLocalization: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameModeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameMode: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GameVersionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var gameversions: [Proto_GameVersion] = []
...
struct Proto_GameVersion: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var features: [Proto_GameVersionFeature] = []
...
struct Proto_GameVersionFeatureResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var gameversionfeatures: [Proto_GameVersionFeature] = []
...
struct Proto_GameVersionFeature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_GameVersionFeatureCategoryEnum = .boolean
  ...
  var values: [Proto_GameVersionFeatureValue] = []
...
struct Proto_GameVersionFeatureValueResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var gameversionfeaturevalues: [Proto_GameVersionFeatureValue] = []
...
struct Proto_GameVersionFeatureValue: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasGameFeature: Bool {return self._gameFeature != nil}
  /// Clears the value of `gameFeature`. Subsequent reads from it will return its default value.
  mutating func clearGameFeature() {self._gameFeature = nil}

  var includedFeature: Proto_GameVersionFeatureValueIncludedFeatureEnum = .notIncluded
...
struct Proto_GameVideoResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var gamevideos: [Proto_GameVideo] = []
...
struct Proto_GameVideo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_GenreResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_InvolvedCompanyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_InvolvedCompany: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_KeywordResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_LanguageResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var languages: [Proto_Language] = []
...
struct Proto_Language: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_LanguageSupportResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_LanguageSupport: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var languageSupportType: Proto_LanguageSupportType {
  ...
  var hasLanguageSupportType: Bool {return _storage._languageSupportType != nil}
  /// Clears the value of `languageSupportType`. Subsequent reads from it will return its default value.
  mutating func clearLanguageSupportType() {_uniqueStorage()._languageSupportType = nil}
...
struct Proto_LanguageSupportTypeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var languagesupporttypes: [Proto_LanguageSupportType] = []
...
struct Proto_LanguageSupportType: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_MultiplayerModeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_MultiplayerMode: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var campaigncoop: Bool = false

  var dropin: Bool = false
  ...
  var lancoop: Bool = false

  var offlinecoop: Bool = false

  var offlinecoopmax: Int32 = 0

  var offlinemax: Int32 = 0

  var onlinecoop: Bool = false

  var onlinecoopmax: Int32 = 0

  var onlinemax: Int32 = 0
  ...
  var splitscreen: Bool = false

  var splitscreenonline: Bool = false
...
struct Proto_NetworkTypeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_NetworkType: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_Platform: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_PlatformCategoryEnum {
    get {return _storage._category}
    set {_uniqueStorage()._category = newValue}
  }
  ...
  var platformLogo: Proto_PlatformLogo {
  ...
  var hasPlatformLogo: Bool {return _storage._platformLogo != nil}
  /// Clears the value of `platformLogo`. Subsequent reads from it will return its default value.
  mutating func clearPlatformLogo() {_uniqueStorage()._platformLogo = nil}

  var platformFamily: Proto_PlatformFamily {
  ...
  var hasPlatformFamily: Bool {return _storage._platformFamily != nil}
  /// Clears the value of `platformFamily`. Subsequent reads from it will return its default value.
  mutating func clearPlatformFamily() {_uniqueStorage()._platformFamily = nil}
  ...
  var versions: [Proto_PlatformVersion] {
    get {return _storage._versions}
    set {_uniqueStorage()._versions = newValue}
  }

  var websites: [Proto_PlatformWebsite] {
    get {return _storage._websites}
    set {_uniqueStorage()._websites = newValue}
  }
...
struct Proto_PlatformFamilyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var platformfamilies: [Proto_PlatformFamily] = []
...
struct Proto_PlatformFamily: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformLogoResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var platformlogos: [Proto_PlatformLogo] = []
...
struct Proto_PlatformLogo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformVersionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var platformversions: [Proto_PlatformVersion] = []
...
struct Proto_PlatformVersion: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var companies: [Proto_PlatformVersionCompany] {
    get {return _storage._companies}
    set {_uniqueStorage()._companies = newValue}
  }
  ...
  var mainManufacturer: Proto_PlatformVersionCompany {
  ...
  var hasMainManufacturer: Bool {return _storage._mainManufacturer != nil}
  /// Clears the value of `mainManufacturer`. Subsequent reads from it will return its default value.
  mutating func clearMainManufacturer() {_uniqueStorage()._mainManufacturer = nil}
  ...
  var platformVersionReleaseDates: [Proto_PlatformVersionReleaseDate] {
...
struct Proto_PlatformVersionCompanyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformVersionCompany: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformVersionReleaseDateResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlatformVersionReleaseDate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var category: Proto_DateFormatChangeDateCategoryEnum = .yyyymmmmdd
...
struct Proto_PlatformWebsiteResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var platformwebsites: [Proto_PlatformWebsite] = []
...
struct Proto_PlatformWebsite: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlayerPerspectiveResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_PlayerPerspective: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_RegionResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var regions: [Proto_Region] = []
...
struct Proto_ReleaseDateResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_ReleaseDate: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var region: Proto_RegionRegionEnum {
  ...
  var status: Proto_ReleaseDateStatus {
...
struct Proto_ReleaseDateStatusResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var releasedatestatuses: [Proto_ReleaseDateStatus] = []
...
struct Proto_ReleaseDateStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_ScreenshotResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_Screenshot: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_SearchResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var searches: [Proto_Search] = []
...
struct Proto_Search: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var hasCharacter: Bool {return _storage._character != nil}
  /// Clears the value of `character`. Subsequent reads from it will return its default value.
  mutating func clearCharacter() {_uniqueStorage()._character = nil}
  ...
  var hasPublishedAt: Bool {return _storage._publishedAt != nil}
  /// Clears the value of `publishedAt`. Subsequent reads from it will return its default value.
  mutating func clearPublishedAt() {_uniqueStorage()._publishedAt = nil}

  var testDummy: Proto_TestDummy {
  ...
  var hasTestDummy: Bool {return _storage._testDummy != nil}
  /// Clears the value of `testDummy`. Subsequent reads from it will return its default value.
  mutating func clearTestDummy() {_uniqueStorage()._testDummy = nil}

  var theme: Proto_Theme {
...
struct Proto_TestDummyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var testdummies: [Proto_TestDummy] = []
...
struct Proto_TestDummy: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var enumTest: Proto_TestDummyEnumTestEnum {
...
struct Proto_ThemeResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Proto_WebsiteResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Proto_Count: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Count, rhs: Proto_Count) -> Bool {
...
extension Proto_MultiQueryResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MultiQueryResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_MultiQueryResult, rhs: Proto_MultiQueryResult) -> Bool {
...
extension Proto_MultiQueryResultArray: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MultiQueryResultArray"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "result"),
  ]
  ...
  static func ==(lhs: Proto_MultiQueryResultArray, rhs: Proto_MultiQueryResultArray) -> Bool {
...
extension Proto_AgeRatingResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AgeRatingResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_AgeRatingResult, rhs: Proto_AgeRatingResult) -> Bool {
...
extension Proto_AgeRating: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AgeRating"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_AgeRating, rhs: Proto_AgeRating) -> Bool {
...
extension Proto_AgeRatingContentDescriptionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AgeRatingContentDescriptionResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_AgeRatingContentDescriptionResult, rhs: Proto_AgeRatingContentDescriptionResult) -> Bool {
...
extension Proto_AgeRatingContentDescription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AgeRatingContentDescription"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
  ...
  static func ==(lhs: Proto_AgeRatingContentDescription, rhs: Proto_AgeRatingContentDescription) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
...
extension Proto_AlternativeNameResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AlternativeNameResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_AlternativeNameResult, rhs: Proto_AlternativeNameResult) -> Bool {
...
extension Proto_AlternativeName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AlternativeName"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_AlternativeName, rhs: Proto_AlternativeName) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Proto_ArtworkResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ArtworkResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_ArtworkResult, rhs: Proto_ArtworkResult) -> Bool {
...
extension Proto_Artwork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Artwork"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_Artwork, rhs: Proto_Artwork) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Proto_CharacterResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CharacterResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_CharacterResult, rhs: Proto_CharacterResult) -> Bool {
...
extension Proto_Character: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Character, rhs: Proto_Character) -> Bool {
...
extension Proto_CharacterMugShotResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CharacterMugShotResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_CharacterMugShotResult, rhs: Proto_CharacterMugShotResult) -> Bool {
...
extension Proto_CharacterMugShot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CharacterMugShot"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "alpha_channel"),
    3: .same(proto: "animated"),
  ...
  static func ==(lhs: Proto_CharacterMugShot, rhs: Proto_CharacterMugShot) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.alphaChannel != rhs.alphaChannel {return false}
    if lhs.animated != rhs.animated {return false}
    if lhs.height != rhs.height {return false}
...
extension Proto_CollectionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_CollectionResult, rhs: Proto_CollectionResult) -> Bool {
...
extension Proto_Collection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    8: .same(proto: "checksum"),
    9: .same(proto: "type"),
    10: .standard(proto: "as_parent_relations"),
    11: .standard(proto: "as_child_relations"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _url: String = String()
    var _checksum: String = String()
    var _type: Proto_CollectionType? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _checksum = source._checksum
      _type = source._type
      _asParentRelations = source._asParentRelations
      _asChildRelations = source._asChildRelations
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeRepeatedMessageField(value: &_storage._games) }()
        ...
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._type) }()
        case 10: try { try decoder.decodeRepeatedMessageField(value: &_storage._asParentRelations) }()
        case 11: try { try decoder.decodeRepeatedMessageField(value: &_storage._asChildRelations) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._asParentRelations.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._asParentRelations, fieldNumber: 10)
      }
      if !_storage._asChildRelations.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._asChildRelations, fieldNumber: 11)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_Collection, rhs: Proto_Collection) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._asParentRelations != rhs_storage._asParentRelations {return false}
        if _storage._asChildRelations != rhs_storage._asChildRelations {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension Proto_CollectionMembershipResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionMembershipResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "collectionmemberships"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.collectionmemberships) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.collectionmemberships.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.collectionmemberships, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_CollectionMembershipResult, rhs: Proto_CollectionMembershipResult) -> Bool {
    if lhs.collectionmemberships != rhs.collectionmemberships {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_CollectionMembership: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionMembership"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "game"),
  ...
  fileprivate class _StorageClass {
    ...
    var _type: Proto_CollectionMembershipType? = nil
    var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _checksum: String = String()
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._collection) }()
  ...
  static func ==(lhs: Proto_CollectionMembership, rhs: Proto_CollectionMembership) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_CollectionMembershipTypeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionMembershipTypeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "collectionmembershiptypes"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.collectionmembershiptypes) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.collectionmembershiptypes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.collectionmembershiptypes, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_CollectionMembershipTypeResult, rhs: Proto_CollectionMembershipTypeResult) -> Bool {
    if lhs.collectionmembershiptypes != rhs.collectionmembershiptypes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_CollectionMembershipType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionMembershipType"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "description"),
    4: .standard(proto: "allowed_collection_type"),
    5: .standard(proto: "updated_at"),
    6: .standard(proto: "created_at"),
    7: .same(proto: "checksum"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.description_p) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._allowedCollectionType) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._allowedCollectionType {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
  ...
  static func ==(lhs: Proto_CollectionMembershipType, rhs: Proto_CollectionMembershipType) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.description_p != rhs.description_p {return false}
    if lhs._allowedCollectionType != rhs._allowedCollectionType {return false}
...
extension Proto_CollectionRelationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionRelationResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "collectionrelations"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.collectionrelations) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.collectionrelations.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.collectionrelations, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_CollectionRelationResult, rhs: Proto_CollectionRelationResult) -> Bool {
    if lhs.collectionrelations != rhs.collectionrelations {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_CollectionRelation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionRelation"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "child_collection"),
    3: .standard(proto: "parent_collection"),
    4: .same(proto: "type"),
    5: .standard(proto: "updated_at"),
    6: .standard(proto: "created_at"),
    7: .same(proto: "checksum"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.id) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._childCollection) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._parentCollection) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._childCollection {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    } }()
  ...
  static func ==(lhs: Proto_CollectionRelation, rhs: Proto_CollectionRelation) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._childCollection != rhs._childCollection {return false}
    if lhs._parentCollection != rhs._parentCollection {return false}
...
extension Proto_CollectionRelationTypeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionRelationTypeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "collectionrelationtypes"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.collectionrelationtypes) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.collectionrelationtypes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.collectionrelationtypes, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_CollectionRelationTypeResult, rhs: Proto_CollectionRelationTypeResult) -> Bool {
    if lhs.collectionrelationtypes != rhs.collectionrelationtypes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_CollectionRelationType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionRelationType"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "description"),
    4: .standard(proto: "allowed_child_type"),
    5: .standard(proto: "allowed_parent_type"),
    6: .standard(proto: "updated_at"),
  ...
  fileprivate class _StorageClass {
    ...
    var _name: String = String()
    var _description_p: String = String()
    var _allowedChildType: Proto_CollectionType? = nil
    var _allowedParentType: Proto_CollectionType? = nil
    var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _checksum: String = String()
    ...
    init(copying source: _StorageClass) {
      ...
      _name = source._name
      _description_p = source._description_p
      _allowedChildType = source._allowedChildType
      _allowedParentType = source._allowedParentType
      _updatedAt = source._updatedAt
      _createdAt = source._createdAt
      _checksum = source._checksum
    }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._allowedChildType) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._allowedParentType) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._updatedAt) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._allowedChildType {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
      } }()
      try { if let v = _storage._allowedParentType {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
      try { if let v = _storage._updatedAt {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
  ...
  static func ==(lhs: Proto_CollectionRelationType, rhs: Proto_CollectionRelationType) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        ...
        if _storage._name != rhs_storage._name {return false}
        if _storage._description_p != rhs_storage._description_p {return false}
        if _storage._allowedChildType != rhs_storage._allowedChildType {return false}
        if _storage._allowedParentType != rhs_storage._allowedParentType {return false}
        if _storage._updatedAt != rhs_storage._updatedAt {return false}
        if _storage._createdAt != rhs_storage._createdAt {return false}
        if _storage._checksum != rhs_storage._checksum {return false}
        return true
...
extension Proto_CollectionTypeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionTypeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "collectiontypes"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.collectiontypes) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.collectiontypes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.collectiontypes, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_CollectionTypeResult, rhs: Proto_CollectionTypeResult) -> Bool {
    if lhs.collectiontypes != rhs.collectiontypes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_CollectionType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CollectionType"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "description"),
  ...
  static func ==(lhs: Proto_CollectionType, rhs: Proto_CollectionType) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.description_p != rhs.description_p {return false}
    if lhs._updatedAt != rhs._updatedAt {return false}
...
extension Proto_CompanyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CompanyResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_CompanyResult, rhs: Proto_CompanyResult) -> Bool {
...
extension Proto_Company: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Company, rhs: Proto_Company) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_CompanyLogoResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CompanyLogoResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Proto_CompanyLogo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CompanyLogo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "alpha_channel"),
    3: .same(proto: "animated"),
  ...
  static func ==(lhs: Proto_CompanyLogo, rhs: Proto_CompanyLogo) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.alphaChannel != rhs.alphaChannel {return false}
    if lhs.animated != rhs.animated {return false}
    if lhs.height != rhs.height {return false}
...
extension Proto_CompanyWebsiteResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CompanyWebsiteResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_CompanyWebsiteResult, rhs: Proto_CompanyWebsiteResult) -> Bool {
...
extension Proto_CompanyWebsite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CompanyWebsite"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
  ...
  static func ==(lhs: Proto_CompanyWebsite, rhs: Proto_CompanyWebsite) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
...
extension Proto_CoverResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CoverResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "covers"),
  ]
  ...
  static func ==(lhs: Proto_CoverResult, rhs: Proto_CoverResult) -> Bool {
...
extension Proto_Cover: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Cover"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "alpha_channel"),
    3: .same(proto: "animated"),
  ...
  static func ==(lhs: Proto_Cover, rhs: Proto_Cover) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_EventResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "events"),
  ]
  ...
  static func ==(lhs: Proto_EventResult, rhs: Proto_EventResult) -> Bool {
...
extension Proto_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "description"),
    4: .same(proto: "slug"),
    5: .standard(proto: "event_logo"),
    6: .standard(proto: "start_time"),
    7: .standard(proto: "time_zone"),
    8: .standard(proto: "end_time"),
    9: .standard(proto: "live_stream_url"),
    10: .same(proto: "games"),
    11: .same(proto: "videos"),
    12: .standard(proto: "event_networks"),
  ...
  fileprivate class _StorageClass {
    ...
    var _description_p: String = String()
    var _slug: String = String()
    var _eventLogo: Proto_EventLogo? = nil
    var _startTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _timeZone: String = String()
    var _endTime: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _liveStreamURL: String = String()
    var _games: [Proto_Game] = []
    var _videos: [Proto_GameVideo] = []
    var _eventNetworks: [Proto_EventNetwork] = []
    var _createdAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _updatedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    var _checksum: String = String()
    ...
    init(copying source: _StorageClass) {
      ...
      _description_p = source._description_p
      _slug = source._slug
      _eventLogo = source._eventLogo
      _startTime = source._startTime
      _timeZone = source._timeZone
      _endTime = source._endTime
      _liveStreamURL = source._liveStreamURL
      _games = source._games
      _videos = source._videos
      _eventNetworks = source._eventNetworks
      _createdAt = source._createdAt
      _updatedAt = source._updatedAt
      _checksum = source._checksum
    }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._eventLogo) }()
        ...
        case 9: try { try decoder.decodeSingularStringField(value: &_storage._liveStreamURL) }()
        case 10: try { try decoder.decodeRepeatedMessageField(value: &_storage._games) }()
        case 11: try { try decoder.decodeRepeatedMessageField(value: &_storage._videos) }()
        case 12: try { try decoder.decodeRepeatedMessageField(value: &_storage._eventNetworks) }()
        ...
        case 15: try { try decoder.decodeSingularStringField(value: &_storage._checksum) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._eventLogo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
      ...
      if !_storage._liveStreamURL.isEmpty {
        try visitor.visitSingularStringField(value: _storage._liveStreamURL, fieldNumber: 9)
      }
      if !_storage._games.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._games, fieldNumber: 10)
      }
      if !_storage._videos.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._videos, fieldNumber: 11)
      }
      if !_storage._eventNetworks.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._eventNetworks, fieldNumber: 12)
      }
      try { if let v = _storage._createdAt {
      ...
      if !_storage._checksum.isEmpty {
        try visitor.visitSingularStringField(value: _storage._checksum, fieldNumber: 15)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Proto_Event, rhs: Proto_Event) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._description_p != rhs_storage._description_p {return false}
        if _storage._slug != rhs_storage._slug {return false}
        if _storage._eventLogo != rhs_storage._eventLogo {return false}
        if _storage._startTime != rhs_storage._startTime {return false}
        if _storage._timeZone != rhs_storage._timeZone {return false}
        if _storage._endTime != rhs_storage._endTime {return false}
        if _storage._liveStreamURL != rhs_storage._liveStreamURL {return false}
        if _storage._games != rhs_storage._games {return false}
        if _storage._videos != rhs_storage._videos {return false}
        if _storage._eventNetworks != rhs_storage._eventNetworks {return false}
        if _storage._createdAt != rhs_storage._createdAt {return false}
        if _storage._updatedAt != rhs_storage._updatedAt {return false}
        if _storage._checksum != rhs_storage._checksum {return false}
        return true
...
extension Proto_EventLogoResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventLogoResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "eventlogos"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.eventlogos) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.eventlogos.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.eventlogos, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_EventLogoResult, rhs: Proto_EventLogoResult) -> Bool {
    if lhs.eventlogos != rhs.eventlogos {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_EventLogo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventLogo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "event"),
    3: .standard(proto: "alpha_channel"),
    4: .same(proto: "animated"),
    5: .same(proto: "height"),
    6: .standard(proto: "image_id"),
    7: .same(proto: "url"),
    8: .same(proto: "width"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 3: try { try decoder.decodeSingularBoolField(value: &_storage._alphaChannel) }()
        case 4: try { try decoder.decodeSingularBoolField(value: &_storage._animated) }()
        case 5: try { try decoder.decodeSingularInt32Field(value: &_storage._height) }()
        case 6: try { try decoder.decodeSingularStringField(value: &_storage._imageID) }()
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._url) }()
        case 8: try { try decoder.decodeSingularInt32Field(value: &_storage._width) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._animated != false {
        try visitor.visitSingularBoolField(value: _storage._animated, fieldNumber: 4)
      }
      if _storage._height != 0 {
        try visitor.visitSingularInt32Field(value: _storage._height, fieldNumber: 5)
      }
  ...
  static func ==(lhs: Proto_EventLogo, rhs: Proto_EventLogo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_EventNetworkResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventNetworkResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "eventnetworks"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.eventnetworks) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.eventnetworks.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.eventnetworks, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_EventNetworkResult, rhs: Proto_EventNetworkResult) -> Bool {
    if lhs.eventnetworks != rhs.eventnetworks {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_EventNetwork: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventNetwork"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "event"),
    3: .same(proto: "url"),
    4: .standard(proto: "network_type"),
    5: .standard(proto: "created_at"),
    6: .standard(proto: "updated_at"),
    7: .same(proto: "checksum"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._networkType) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._createdAt) }()
  ...
  static func ==(lhs: Proto_EventNetwork, rhs: Proto_EventNetwork) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Proto_ExternalGameResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExternalGameResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_ExternalGameResult, rhs: Proto_ExternalGameResult) -> Bool {
...
extension Proto_ExternalGame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExternalGame"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
  ...
  static func ==(lhs: Proto_ExternalGame, rhs: Proto_ExternalGame) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs._game != rhs._game {return false}
...
extension Proto_FranchiseResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".FranchiseResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_FranchiseResult, rhs: Proto_FranchiseResult) -> Bool {
...
extension Proto_Franchise: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Franchise"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
    3: .same(proto: "games"),
  ...
  static func ==(lhs: Proto_Franchise, rhs: Proto_Franchise) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
...
extension Proto_GameResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "games"),
  ]
  ...
  static func ==(lhs: Proto_GameResult, rhs: Proto_GameResult) -> Bool {
    if lhs.games != rhs.games {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Proto_Game: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Game, rhs: Proto_Game) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_GameEngineResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameEngineResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameEngineResult, rhs: Proto_GameEngineResult) -> Bool {
...
extension Proto_GameEngine: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameEngine"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_GameEngine, rhs: Proto_GameEngine) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_GameEngineLogoResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameEngineLogoResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameEngineLogoResult, rhs: Proto_GameEngineLogoResult) -> Bool {
...
extension Proto_GameEngineLogo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameEngineLogo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "alpha_channel"),
    3: .same(proto: "animated"),
  ...
  static func ==(lhs: Proto_GameEngineLogo, rhs: Proto_GameEngineLogo) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.alphaChannel != rhs.alphaChannel {return false}
    if lhs.animated != rhs.animated {return false}
    if lhs.height != rhs.height {return false}
...
extension Proto_GameLocalizationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameLocalizationResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameLocalizationResult, rhs: Proto_GameLocalizationResult) -> Bool {
...
extension Proto_GameLocalization: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameLocalization"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "cover"),
  ...
  static func ==(lhs: Proto_GameLocalization, rhs: Proto_GameLocalization) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_GameModeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameModeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameModeResult, rhs: Proto_GameModeResult) -> Bool {
...
extension Proto_GameMode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameMode"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_GameMode, rhs: Proto_GameMode) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
...
extension Proto_GameVersionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersionResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameVersionResult, rhs: Proto_GameVersionResult) -> Bool {
...
extension Proto_GameVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersion"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
  ...
  static func ==(lhs: Proto_GameVersion, rhs: Proto_GameVersion) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
...
extension Proto_GameVersionFeatureResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersionFeatureResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameVersionFeatureResult, rhs: Proto_GameVersionFeatureResult) -> Bool {
...
extension Proto_GameVersionFeature: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersionFeature"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
    3: .same(proto: "description"),
  ...
  static func ==(lhs: Proto_GameVersionFeature, rhs: Proto_GameVersionFeature) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
    if lhs.description_p != rhs.description_p {return false}
...
extension Proto_GameVersionFeatureValueResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersionFeatureValueResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameVersionFeatureValueResult, rhs: Proto_GameVersionFeatureValueResult) -> Bool {
...
extension Proto_GameVersionFeatureValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVersionFeatureValue"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "game"),
  ...
  static func ==(lhs: Proto_GameVersionFeatureValue, rhs: Proto_GameVersionFeatureValue) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._game != rhs._game {return false}
...
extension Proto_GameVideoResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVideoResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_GameVideoResult, rhs: Proto_GameVideoResult) -> Bool {
...
extension Proto_GameVideo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GameVideo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "game"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_GameVideo, rhs: Proto_GameVideo) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._game != rhs._game {return false}
    if lhs.name != rhs.name {return false}
...
extension Proto_GenreResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GenreResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "genres"),
  ]
  ...
  static func ==(lhs: Proto_GenreResult, rhs: Proto_GenreResult) -> Bool {
...
extension Proto_Genre: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Genre, rhs: Proto_Genre) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
...
extension Proto_InvolvedCompanyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".InvolvedCompanyResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_InvolvedCompanyResult, rhs: Proto_InvolvedCompanyResult) -> Bool {
...
extension Proto_InvolvedCompany: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".InvolvedCompany"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_InvolvedCompany, rhs: Proto_InvolvedCompany) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Proto_KeywordResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".KeywordResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_KeywordResult, rhs: Proto_KeywordResult) -> Bool {
...
extension Proto_Keyword: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Keyword"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_Keyword, rhs: Proto_Keyword) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
...
extension Proto_LanguageResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LanguageResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_LanguageResult, rhs: Proto_LanguageResult) -> Bool {
...
extension Proto_Language: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Language, rhs: Proto_Language) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
...
extension Proto_LanguageSupportResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LanguageSupportResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Proto_LanguageSupport: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LanguageSupport"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "game"),
  ...
  static func ==(lhs: Proto_LanguageSupport, rhs: Proto_LanguageSupport) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_LanguageSupportTypeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LanguageSupportTypeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_LanguageSupportTypeResult, rhs: Proto_LanguageSupportTypeResult) -> Bool {
...
extension Proto_LanguageSupportType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LanguageSupportType"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .standard(proto: "created_at"),
  ...
  static func ==(lhs: Proto_LanguageSupportType, rhs: Proto_LanguageSupportType) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs._updatedAt != rhs._updatedAt {return false}
...
extension Proto_MultiplayerModeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MultiplayerModeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Proto_MultiplayerMode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".MultiplayerMode"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_MultiplayerMode, rhs: Proto_MultiplayerMode) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Proto_NetworkTypeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NetworkTypeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "networktypes"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.networktypes) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.networktypes.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.networktypes, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Proto_NetworkTypeResult, rhs: Proto_NetworkTypeResult) -> Bool {
    if lhs.networktypes != rhs.networktypes {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Proto_NetworkType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NetworkType"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .standard(proto: "event_networks"),
    4: .standard(proto: "created_at"),
    5: .standard(proto: "updated_at"),
    6: .same(proto: "checksum"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.id) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.name) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.eventNetworks) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.eventNetworks.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.eventNetworks, fieldNumber: 3)
    }
    try { if let v = self._createdAt {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    } }()
  ...
  static func ==(lhs: Proto_NetworkType, rhs: Proto_NetworkType) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.eventNetworks != rhs.eventNetworks {return false}
    if lhs._createdAt != rhs._createdAt {return false}
...
extension Proto_PlatformResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformResult, rhs: Proto_PlatformResult) -> Bool {
...
extension Proto_Platform: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Platform, rhs: Proto_Platform) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_PlatformFamilyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformFamilyResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformFamilyResult, rhs: Proto_PlatformFamilyResult) -> Bool {
...
extension Proto_PlatformFamily: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformFamily"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "slug"),
  ...
  static func ==(lhs: Proto_PlatformFamily, rhs: Proto_PlatformFamily) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
    if lhs.checksum != rhs.checksum {return false}
...
extension Proto_PlatformLogoResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformLogoResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformLogoResult, rhs: Proto_PlatformLogoResult) -> Bool {
...
extension Proto_PlatformLogo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformLogo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "alpha_channel"),
    3: .same(proto: "animated"),
  ...
  static func ==(lhs: Proto_PlatformLogo, rhs: Proto_PlatformLogo) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.alphaChannel != rhs.alphaChannel {return false}
    if lhs.animated != rhs.animated {return false}
    if lhs.height != rhs.height {return false}
...
extension Proto_PlatformVersionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersionResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformVersionResult, rhs: Proto_PlatformVersionResult) -> Bool {
...
extension Proto_PlatformVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersion"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "companies"),
  ...
  static func ==(lhs: Proto_PlatformVersion, rhs: Proto_PlatformVersion) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_PlatformVersionCompanyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersionCompanyResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformVersionCompanyResult, rhs: Proto_PlatformVersionCompanyResult) -> Bool {
...
extension Proto_PlatformVersionCompany: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersionCompany"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "comment"),
  ...
  static func ==(lhs: Proto_PlatformVersionCompany, rhs: Proto_PlatformVersionCompany) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.comment != rhs.comment {return false}
    if lhs._company != rhs._company {return false}
    if lhs.developer != rhs.developer {return false}
...
extension Proto_PlatformVersionReleaseDateResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersionReleaseDateResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformVersionReleaseDateResult, rhs: Proto_PlatformVersionReleaseDateResult) -> Bool {
...
extension Proto_PlatformVersionReleaseDate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformVersionReleaseDate"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
    3: .standard(proto: "created_at"),
  ...
  static func ==(lhs: Proto_PlatformVersionReleaseDate, rhs: Proto_PlatformVersionReleaseDate) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
    if lhs._createdAt != rhs._createdAt {return false}
...
extension Proto_PlatformWebsiteResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformWebsiteResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlatformWebsiteResult, rhs: Proto_PlatformWebsiteResult) -> Bool {
...
extension Proto_PlatformWebsite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlatformWebsite"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
    3: .same(proto: "trusted"),
  ...
  static func ==(lhs: Proto_PlatformWebsite, rhs: Proto_PlatformWebsite) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
    if lhs.trusted != rhs.trusted {return false}
    if lhs.url != rhs.url {return false}
...
extension Proto_PlayerPerspectiveResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlayerPerspectiveResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_PlayerPerspectiveResult, rhs: Proto_PlayerPerspectiveResult) -> Bool {
...
extension Proto_PlayerPerspective: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PlayerPerspective"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_PlayerPerspective, rhs: Proto_PlayerPerspective) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
...
extension Proto_RegionResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RegionResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_RegionResult, rhs: Proto_RegionResult) -> Bool {
...
extension Proto_Region: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Region, rhs: Proto_Region) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.category != rhs.category {return false}
...
extension Proto_ReleaseDateResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReleaseDateResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_ReleaseDateResult, rhs: Proto_ReleaseDateResult) -> Bool {
...
extension Proto_ReleaseDate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReleaseDate"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "category"),
    3: .standard(proto: "created_at"),
  ...
  static func ==(lhs: Proto_ReleaseDate, rhs: Proto_ReleaseDate) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_ReleaseDateStatusResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReleaseDateStatusResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_ReleaseDateStatusResult, rhs: Proto_ReleaseDateStatusResult) -> Bool {
...
extension Proto_ReleaseDateStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ReleaseDateStatus"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "name"),
    3: .same(proto: "description"),
  ...
  static func ==(lhs: Proto_ReleaseDateStatus, rhs: Proto_ReleaseDateStatus) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.name != rhs.name {return false}
    if lhs.description_p != rhs.description_p {return false}
    if lhs._createdAt != rhs._createdAt {return false}
...
extension Proto_ScreenshotResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ScreenshotResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_ScreenshotResult, rhs: Proto_ScreenshotResult) -> Bool {
...
extension Proto_Screenshot: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Screenshot, rhs: Proto_Screenshot) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.alphaChannel != rhs.alphaChannel {return false}
    if lhs.animated != rhs.animated {return false}
    if lhs._game != rhs._game {return false}
...
extension Proto_SearchResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_SearchResult, rhs: Proto_SearchResult) -> Bool {
...
extension Proto_Search: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Search"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_Search, rhs: Proto_Search) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_TestDummyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestDummyResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_TestDummyResult, rhs: Proto_TestDummyResult) -> Bool {
...
extension Proto_TestDummy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".TestDummy"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  static func ==(lhs: Proto_TestDummy, rhs: Proto_TestDummy) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Proto_ThemeResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ThemeResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "themes"),
  ]
  ...
  static func ==(lhs: Proto_ThemeResult, rhs: Proto_ThemeResult) -> Bool {
...
extension Proto_Theme: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Theme"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .standard(proto: "created_at"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Proto_Theme, rhs: Proto_Theme) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs._createdAt != rhs._createdAt {return false}
    if lhs.name != rhs.name {return false}
    if lhs.slug != rhs.slug {return false}
...
extension Proto_WebsiteResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WebsiteResult"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Proto_WebsiteResult, rhs: Proto_WebsiteResult) -> Bool {
...
extension Proto_Website: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Proto_Website, rhs: Proto_Website) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.category != rhs.category {return false}
    if lhs._game != rhs._game {return false}
    if lhs.trusted != rhs.trusted {return false}
